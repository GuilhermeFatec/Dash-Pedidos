...
import { MdAssessment, MdCancel, MdDelete, MdModeEdit, MdSave } from 'react-icons/md'
...
const Finalizados = () => {
    ...
    //Filtrando os pedidos finalizados e omando os valores totais .    
    ...
    useEffect(() => {
        obterPedidos()
        document.title = "Pedidos finalizados"
    }, [])
    ...
    const validaErrosPedido = () => {
        ...
        else if (Status === "") novosErros.Status = "Selecione um Status válido"
    ...
    return (
        <Container fluid className="p-0">
            ...
            <Row>
                <Col xs={12} lg={12}>
                    <div className="valorestotal"> Total de R$ {valorTotal.toLocaleString('pt-BR')} em {finalizado.length} atividades &nbsp;&nbsp;
